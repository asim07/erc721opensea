...
GOOGLE_STORAGE_PROJECT = "credentials/google-storage-credentials.json"
GOOGLE_STORAGE_BUCKET = "my-trait-app"
...
FIRST_NAMES = ["asim", "asim", "asim", "asim", "asim", "asim"]
...
ACCESSORIES_NAMES = [
    a.replace("-", " ").replace(".png", "") for a in ACCESSORIES_IMAGES
]
...
ACCESSORIES_ATTS_RARITY = ["Common", "Rare", "Legendary", "Epic", "Divine", "Hidden"]
ACCESSORIES_ATTS_DEPTH = ["beach", "shore", "shallows", "deeps", "shore", "deeps"]
...
def creature(token_id):
    ...
    creature_name = "%s %s" % (
        FIRST_NAMES[token_id % num_first_names],
        LAST_NAMES[token_id % num_last_names],
    )
    ...
    _add_attribute(
        attributes,
        "Stamina Increase",
        PERCENT_BOOST_ATTRIBUTES,
        token_id,
        display_type="boost_percentage",
    )
    _add_attribute(
        attributes, "Generation", NUMBER_ATTRIBUTES, token_id, display_type="number"
    )
...
def creature_factory(token_id):
    ...
    if token_id == 0:
        ...
        description = (
            "When you purchase this option, you will receive a single OpenSea creature of a random variety. "
        ...
        description = (
            "When you purchase this option, you will receive four OpenSea creatures of random variety. "
        ...
        description = (
            "When you purchase this option, you will receive one lootbox, which can be opened to reveal three "
...
def accessory_factory(token_id):
    ...
    if token_id == 0:
        ...
        description = (
            "When you purchase this option, you will receive a single OpenSea creature accessory of a random variety. "
            "Enjoy and take good care of your aquatic being!"
        )
        image_url = _compose_image(["images/factory/egg.png"], token_id, "factory")
        num_inside = 1
        ...
        description = (
            "When you purchase this option, you will receive four OpenSea creature accessories of random variety. "
            "Enjoy and take good care of your aquatic beings!"
        )
        image_url = _compose_image(
            ["images/factory/four-eggs.png"], token_id, "factory"
...
def _add_attribute(existing, attribute_name, options, token_id, display_type=None):
    trait = {"trait_type": attribute_name, "value": options[token_id % len(options)]}
    if display_type:
